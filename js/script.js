        ...
        const appData = {
            ...
            "works": [
                ...
                },
                {
                    ...
                    "image": "./images/work_compensation.png",
        ...
        function renderCommonElements() {
            document.getElementById('footer-area').textContent = appData.site.area;
            document.getElementById('footer-tel').textContent = appData.site.contact.tel;
        ...
        function handleRoute() {
            ...
            // Default header state (Solid for standard pages, Transparent for Hero pages)
            if (path === '/' || path === '/works' || path === '/careers') {
                renderHome(); // (Note: Logic adjusted below)
                if (path === '/') { renderHome(); document.getElementById('page-home').classList.add('active'); }
                else if (path === '/works') { renderWorks(); document.getElementById('page-works').classList.add('active'); }
                else if (path === '/careers') { renderCareers(); document.getElementById('page-careers').classList.add('active'); }

                header.classList.add('header-transparent');
                header.classList.remove('bg-brandNavy');
            } else {
                // Pages without dark hero (Contact, Privacy, Sitemap)
                if (path.startsWith('/contact')) { renderContact(); document.getElementById('page-contact').classList.add('active'); }
                else if (path === '/privacy') { renderPrivacy(); document.getElementById('page-privacy').classList.add('active'); }
                else if (path === '/sitemap') { renderSitemap(); document.getElementById('page-sitemap').classList.add('active'); }
                            ...
                            <div class="md:w-2/3 grid gap-12">
                                ...
                                <div class="group reveal delay-100 grid md:grid-cols-2 gap-8 items-center">
                                    <div class="overflow-hidden bg-gray-100 aspect-[4/3] relative">
                                        <img src="./images/service_survey.png" class="w-full h-full object-cover transition duration-700 group-hover:scale-110">
                                    </div>
                                    <div>
                                        ...
                                        <p class="text-gray-500 text-sm leading-relaxed mb-6">
                                            基準点測量から用地測量まで、最新の機器と技術を駆使して高精度な成果を作成します。
                                        </p>
                                        <ul class="space-y-2 text-sm text-brandNavy font-medium">
                                            <li class="flex items-center gap-2"><span class="w-1.5 h-1.5 bg-brandGold"></span> 基準点測量 / 応用測量</li>
                                            <li class="flex items-center gap-2"><span class="w-1.5 h-1.5 bg-brandGold"></span> 地形測量 / 用地測量</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="group reveal delay-200 grid md:grid-cols-2 gap-8 items-center md:flex-row-reverse">
                                    <div class="md:order-2 overflow-hidden bg-gray-100 aspect-[4/3] relative">
                                        <img src="./images/service_compensation.png" class="w-full h-full object-cover transition duration-700 group-hover:scale-110">
                                    </div>
                                    <div class="md:order-1">
                                        ...
                                        <p class="text-gray-500 text-sm leading-relaxed mb-6">
                                            公共事業に伴う損失補償や権利調査を行い、事業の円滑な進行と合意形成をサポートします。
                                        </p>
                                        <ul class="space-y-2 text-sm text-brandNavy font-medium">
                                            <li class="flex items-center gap-2"><span class="w-1.5 h-1.5 bg-brandGold"></span> 土地調査 / 物件調査</li>
                                            <li class="flex items-center gap-2"><span class="w-1.5 h-1.5 bg-brandGold"></span> 補償額算定</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container mx-auto px-6 max-w-4xl">
                        ...
                        <div class="reveal delay-100">
                            <dl class="grid md:grid-cols-12 border-t border-line">
                                ...
                                <div class="md:col-span-8 py-5 border-b border-line md:border-b-0 md:border-t-0 text-gray-600 flex items-center">株式会社国土調査設計事務所</div>
                                
                                <div class="md:col-span-12 h-[1px] bg-line hidden md:block"></div>

                                <div class="md:col-span-4 py-5 font-bold text-brandNavy flex items-center">設立日</div>
                                <div class="md:col-span-8 py-5 border-b border-line md:border-b-0 md:border-t-0 text-gray-600 flex items-center">1971年7月6日</div>
                                
                                <div class="md:col-span-12 h-[1px] bg-line hidden md:block"></div>

                                <div class="md:col-span-4 py-5 font-bold text-brandNavy flex items-center">資本金</div>
                                <div class="md:col-span-8 py-5 border-b border-line md:border-b-0 md:border-t-0 text-gray-600 flex items-center">3,000,000円</div>

                                <div class="md:col-span-12 h-[1px] bg-line hidden md:block"></div>

                                <div class="md:col-span-4 py-5 font-bold text-brandNavy flex items-center">測量業者登録</div>
                                <div class="md:col-span-8 py-5 border-b border-line md:border-b-0 md:border-t-0 text-gray-600 flex items-center">登録番号（確認中）</div>

                                <div class="md:col-span-12 h-[1px] bg-line hidden md:block"></div>

                                <div class="md:col-span-4 py-5 font-bold text-brandNavy flex items-center">代表者名</div>
                                <div class="md:col-span-8 py-5 border-b border-line md:border-b-0 md:border-t-0 text-gray-600 flex items-center">吉田 友彦</div>

                                <div class="md:col-span-12 h-[1px] bg-line hidden md:block"></div>

                                <div class="md:col-span-4 py-5 font-bold text-brandNavy flex items-center">所在地</div>
                                <div class="md:col-span-8 py-5 border-b border-line md:border-b-0 md:border-t-0 text-gray-600 flex items-center">奈良県大和郡山市小泉町187-1</div>

                                <div class="md:col-span-12 h-[1px] bg-line hidden md:block"></div>

                                <div class="md:col-span-4 py-5 font-bold text-brandNavy flex items-center">事業内容</div>
                                <div class="md:col-span-8 py-5 border-b border-line md:border-b-0 md:border-t-0 text-gray-600 flex items-center">測量・設計・地籍調査等</div>
                            </dl>

                            <!-- Map -->
                            <div class="mt-12 h-80 md:h-[450px] w-full bg-gray-100 shadow-inner rounded-sm overflow-hidden border border-line">
                                <iframe src="https://maps.google.com/maps?q=奈良県大和郡山市小泉町187-1&output=embed" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                            </div>
                        </div>
                    </div>
                </section>
        ...
        function renderWorks() {
            ...
            container.innerHTML = `
                <div class="pt-32 pb-20 container mx-auto px-6 min-h-screen">
                    <div class="mb-16 reveal">
                        ...
                        <div class="w-16 h-1 bg-brandGold mb-8"></div>
                        <p class="text-gray-500 mb-12 leading-relaxed text-justify md:text-left">
            ...
            // Re-init Reveal to show (un-hide) elements
                ...
                <div class="container mx-auto px-6 py-24">
                    ...
                    <div class="grid md:grid-cols-12 gap-12 items-center mb-24 reveal">
                        <div class="md:col-span-5">
                            <div class="text-brandGold font-en font-bold text-sm tracking-widest mb-4">OUR MISSION</div>
                            ...
                            <p class="text-gray-600 leading-loose mb-8 text-justify">
                                私たちの成果物は、地図に残り、社会インフラの基礎となります。<br>
                                正確さと誠実さが求められる現場で、プロフェッショナルとしてのキャリアを築きませんか。<br>
                                最新の技術と、ベテランの知恵が融合する環境で、あなたの可能性を広げてください。
                            </p>
                        </div>
                        <div class="md:col-span-7 relative">
                            <!-- Image -->
                            <div class="relative overflow-hidden rounded-sm shadow-2xl group">
                                <img src="./images/recruit.jpg" alt="現場での打ち合わせ" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                                <div class="absolute inset-0 bg-brandNavy/10 group-hover:bg-transparent transition duration-500"></div>
                            </div>
                            <!-- Decorative Box -->
                            <div class="absolute -bottom-6 -left-6 w-24 h-24 bg-line/50 -z-10 rounded-sm"></div>
                            <div class="absolute -top-6 -right-6 w-24 h-24 bg-brandGold/20 -z-10 rounded-full blur-xl"></div>
                        </div>
                    </div>

                    <!-- Statistics Bar (Fixed) -->
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-y border-line mb-24 reveal delay-100">
                        <div class="text-center group">
                            <div class="text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider">Qualified</div>
                            <div class="text-4xl font-en font-bold text-brandNavy group-hover:text-brandGold transition-colors">${site.qualified[0].count}<span class="text-sm font-sans font-normal text-gray-500 ml-1">名</span></div>
                            <div class="text-xs text-brandNavy mt-1">測量士</div>
                        </div>
                        <div class="text-center group border-l border-line">
                            <div class="text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider">Holidays</div>
                            <div class="text-4xl font-en font-bold text-brandNavy group-hover:text-brandGold transition-colors">120<span class="text-sm font-sans font-normal text-gray-500 ml-1">日</span></div>
                            <div class="text-xs text-brandNavy mt-1">年間休日</div>
                        </div>
                        <div class="text-center group border-l border-line">
                            <div class="text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider">Established</div>
                            <div class="text-4xl font-en font-bold text-brandNavy group-hover:text-brandGold transition-colors">40<span class="text-sm font-sans font-normal text-gray-500 ml-1">年</span></div>
                            <div class="text-xs text-brandNavy mt-1">創業</div>
                        </div>
                        <div class="text-center group border-l border-line">
                            <div class="text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider">Location</div>
                            <div class="text-4xl font-en font-bold text-brandNavy group-hover:text-brandGold transition-colors">KANSAI</div>
                            <div class="text-xs text-brandNavy mt-1">関西エリア中心</div>
                        </div>
                    </div>
                    ...
                    <div class="relative bg-brandNavy text-white p-8 md:p-16 rounded-sm text-center shadow-xl overflow-hidden group reveal">
                        ...
                        <div class="absolute inset-0 z-0">
                            <img src="./images/recruit.jpg" alt="背景" class="w-full h-full object-cover group-hover:scale-105 transition duration-1000">
                            <!-- 写真が見えるように薄めのオーバーレイ (50%) -->
                            <div class="absolute inset-0 bg-brandNavy/50 transition duration-500"></div>
                        </div>
                        
                        <!-- Hover Animation Overlay (左から右へ色が広がる：明るいシアン) -->
                        <div class="absolute inset-0 z-0 bg-accentCyan/30 transform scale-x-0 group-hover:scale-x-100 transition duration-700 origin-left"></div>
                        
                        <div class="relative z-10">
                            <h2 class="text-2xl font-bold mb-4 drop-shadow-md">Entry / Contact</h2>
                            <p class="text-gray-100 mb-8 text-sm max-w-lg mx-auto leading-relaxed drop-shadow-md">
                                経験・未経験は問いません。面接というより、まずは相互理解の場としてお話ししましょう。<br>
                                下記フォームより「採用について」を選択してご連絡ください。
                            </p>
                            <a href="#/contact?type=recruit" class="inline-flex items-center gap-2 bg-blue-600 text-white px-10 py-4 font-bold hover:bg-white hover:text-blue-600 transition duration-300 shadow-lg border border-transparent hover:border-blue-600">
                ...
                <div class="pt-32 pb-24 container mx-auto px-6 min-h-screen max-w-4xl">
                    ...
                    <div class="bg-white border border-line p-8 md:p-12 reveal delay-100">
                        ...
                        <div class="text-center pt-8 border-t border-line">
                            ...
                            <p class="text-xs text-gray-400 mt-2">※いずれも外部フォーム（Google Forms）へ移動します</p>
                        </div>
                    </div>
                </div>
            `;
            ...
            container.innerHTML = `
                <div class="pt-32 pb-24 container mx-auto px-6 min-h-screen max-w-3xl">
                    ...
                    <div class="bg-white border border-line p-8 md:p-16 reveal delay-100 text-sm leading-relaxed text-gray-600 space-y-8">
                        <div>
                            <p>株式会社国土調査設計事務所（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。</p>
                        </div>

                        <div>
                            <h3 class="text-brandNavy font-bold mb-3 border-l-4 border-brandGold pl-3">第1条（個人情報）</h3>
                            <p>「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>
                        </div>

                        <div>
                            <h3 class="text-brandNavy font-bold mb-3 border-l-4 border-brandGold pl-3">第2条（個人情報の収集方法）</h3>
                        ...
                        <div>
                            <h3 class="text-brandNavy font-bold mb-3 border-l-4 border-brandGold pl-3">第3条（個人情報を収集・利用する目的）</h3>
                        ...
                        <div>
                            <h3 class="text-brandNavy font-bold mb-3 border-l-4 border-brandGold pl-3">第4条（利用目的の変更）</h3>
                        ...
                        <div>
                            <h3 class="text-brandNavy font-bold mb-3 border-l-4 border-brandGold pl-3">第5条（個人情報の第三者提供）</h3>
                        ...
                        <div>
                            <h3 class="text-brandNavy font-bold mb-3 border-l-4 border-brandGold pl-3">第6条（お問い合わせ窓口）</h3>
                            <p>本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
                            <div class="mt-4 bg-gray-50 p-4 border border-line">
                                <p>住所：${site.area}</p>
                                <p>社名：${site.companyName}</p>
                    ...
                    <div class="bg-white border border-line p-8 md:p-16 reveal delay-100">
                        <div class="grid md:grid-cols-2 gap-12">
                            <div>
                                ...
                                <ul class="space-y-4">
                                    <li>
                                        <a href="#/" class="font-bold text-brandNavy hover:text-brandGold transition-colors flex items-center gap-2">
                                            <i data-lucide="home" class="w-4 h-4"></i> ホーム
                                        </a>
                                        <ul class="ml-6 mt-2 space-y-2 text-sm text-gray-600">
                                            <li><a href="#/" class="hover:text-brandNavy transition-colors">・トップ</a></li>
                                            <li><a href="#/" class="hover:text-brandNavy transition-colors">・会社概要</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#/works" class="font-bold text-brandNavy hover:text-brandGold transition-colors flex items-center gap-2">
                                            <i data-lucide="briefcase" class="w-4 h-4"></i> 業務実績
                                        </a>
                                        <ul class="ml-6 mt-2 space-y-2 text-sm text-gray-600">
                                            <li><a href="#/works" onclick="setFilter('survey')" class="hover:text-brandNavy transition-colors">・測量業務</a></li>
                                            <li><a href="#/works" onclick="setFilter('compensation')" class="hover:text-brandNavy transition-colors">・補償コンサルタント</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#/careers" class="font-bold text-brandNavy hover:text-brandGold transition-colors flex items-center gap-2">
                                            <i data-lucide="users" class="w-4 h-4"></i> 採用情報
                                        </a>
                                        <ul class="ml-6 mt-2 space-y-2 text-sm text-gray-600">
                                            <li><a href="#/careers" class="hover:text-brandNavy transition-colors">・募集要項</a></li>
                                            <li><a href="#/contact?type=recruit" class="hover:text-brandNavy transition-colors">・エントリー</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="space-y-4">
                                    <li>
                                        <a href="#/contact" class="font-bold text-brandNavy hover:text-brandGold transition-colors flex items-center gap-2">
                                            <i data-lucide="mail" class="w-4 h-4"></i> お問い合わせ
                                        </a>
                                        <ul class="ml-6 mt-2 space-y-2 text-sm text-gray-600">
                                            <li><a href="#/contact?type=biz" class="hover:text-brandNavy transition-colors">・業務のご相談</a></li>
                                            <li><a href="#/contact?type=quote" class="hover:text-brandNavy transition-colors">・お見積り依頼</a></li>
                                        </ul>
                                    </li>
                                </ul>

                                <h3 class="text-xl font-bold text-brandNavy mb-6 border-b border-brandGold pb-2 inline-block mt-12">LEGAL</h3>
                                <ul class="space-y-4">
                                    <li>
                                        <a href="#/privacy" class="font-bold text-brandNavy hover:text-brandGold transition-colors flex items-center gap-2">
                                            <i data-lucide="shield" class="w-4 h-4"></i> プライバシーポリシー
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#/sitemap" class="font-bold text-brandNavy hover:text-brandGold transition-colors flex items-center gap-2">
                                            <i data-lucide="map" class="w-4 h-4"></i> サイトマップ
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        window.openCareerModal = (id) => {
            ...
            modalContent.innerHTML = `
                ...
                <div class="p-8 md:p-12 overflow-y-auto max-h-[60vh] md:max-h-full">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h4 class="text-xs font-bold text-brandGold uppercase tracking-widest mb-2">JOB DESCRIPTION</h4>
                            <p class="text-sm text-gray-600 leading-relaxed">
                                【業務内容】<br>
                                ・公共事業に伴う測量・補償コンサルタント業務<br>
                                ・CADを用いた図面作成、報告書作成<br>
                                ・関係機関との協議・打合せ<br>
                                ※現場とオフィスの割合は概ね5:5です。
                            </p>
                        </div>
                        <div>
                            <h4 class="text-xs font-bold text-brandGold uppercase tracking-widest mb-2">CONDITIONS</h4>
                            <ul class="text-sm text-gray-600 space-y-2">
                                <li class="flex items-start gap-2"><span class="text-brandGold">・</span>勤務地：本社（奈良県大和郡山市） ※現場は関西エリア中心</li>
                                <li class="flex items-start gap-2"><span class="text-brandGold">・</span>勤務時間：9:00 - 18:00（休憩60分）</li>
                                <li class="flex items-start gap-2"><span class="text-brandGold">・</span>給与：経験・能力・前職給与を考慮の上決定</li>
                                <li class="flex items-start gap-2"><span class="text-brandGold">・</span>休日休暇：完全週休2日制（土日祝）、GW、夏季、年末年始</li>
                                <li class="flex items-start gap-2"><span class="text-brandGold">・</span>待遇：昇給年1回、賞与年2回、社会保険完備、交通費支給</li>
                            </ul>
                        </div>
                    </div>

                    <div class="mt-8 pt-8 border-t border-line">
                        <a href="#/contact?type=recruit" onclick="closeModal()" class="block w-full text-center bg-brandNavy text-white py-4 font-bold tracking-widest hover:bg-brandGold transition-colors">
                            この求人にエントリーする
                        </a>
                    </div>
                </div>
        ...
        window.openWorkModal = (id) => {
            ...
            modalContent.innerHTML = `
                ...
                <div class="p-8 md:p-12 overflow-y-auto max-h-[60vh] md:max-h-full">
                    ...
                    <div class="space-y-8">
                        <div>
                            <h4 class="text-xs font-bold text-brandGold uppercase tracking-widest mb-3">SUMMARY</h4>
                            <p class="text-ink leading-relaxed">${w.summary}</p>
                        </div>
                        ${w.details ? `
                        <div>
                            <h4 class="text-xs font-bold text-brandGold uppercase tracking-widest mb-3">DETAILS</h4>
                            <div class="grid gap-6">
                                <div>
                                    <span class="text-xs font-bold text-brandNavy block mb-1">課題</span>
                                    <p class="text-sm text-gray-600">${w.details.issue}</p>
                                </div>
                                <div>
                                    <span class="text-xs font-bold text-brandNavy block mb-1">アプローチ</span>
                                    <p class="text-sm text-gray-600">${w.details.approach}</p>
                                </div>
                            </div>
                        </div>
                        ` : ''}
        ...
        window.updateContactType = (type) => {
            window.location.hash = `#/contact?type=${type}`;
            renderContact();
            if (window.lucide) lucide.createIcons();
        };
